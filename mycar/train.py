    ...
    def generator(save_best, opts, data, batch_size, isTrainSet=True, min_records_to_train=1000):
        ...
        while True:
            ...
            for key in keys:
                ...
                _record["json_data"]["slam_points"] = ast.literal_eval(_record["json_data"]["slam_points"])
                _record["json_data"]["slam_points"] = np.array(_record["json_data"]["slam_points"])
                ...
                if len(batch_data) == batch_size:
                    ...
                    for record in batch_data:
                        ...
                        out.append([record['angle'], record['throttle'], record["json_data"]["slam_points"]])
...
def sequence_train(cfg, tub_names, model_name, transfer_model, model_type, continuous, aug):
    ...
    for record_path in records:
        ...
        ### NEED TO LOAD IN SLAM POINT DATA HERE
